...
export interface Project { id: number; title: string; description: string; descriptionEn: string; role: string; roleEn: string; category: ProjectCategory; technologies: string[]; image: string; images?: string[]; video?: string; videos?: string[]; github?: string; demo?: string; }
